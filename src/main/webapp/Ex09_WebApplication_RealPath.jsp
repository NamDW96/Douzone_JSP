...
C:\Douzone\Web\WebBack\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
...
<body>
	<%
		...
		String filepath = application.getRealPath(resourcepath); //WebJSP
		out.print("file Rea lPath 실제 경로 :" + filepath + "<br>");	
		//실 베포 경로
		
		//개발 소스 경로
		//C:\Douzone\Web\WebBack\WebLabs\WebJSP\src\main\webapp\download\note.txt
		...
		/*
			URL : http://localhost:8090/WebJSP/Ex09_WebApplication_RealPath.jsp
			URI : /WebJSP/Ex09_WebApplication_RealPath.jsp
			CP : /WebJSP	
			SP : /Ex09_WebApplication_RealPath.jsp
		*/
	%>
</body>
</html>