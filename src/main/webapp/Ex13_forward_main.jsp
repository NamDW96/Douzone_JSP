...
1. include (공통 디자인) > 공통 페이지 만들고(top, bottom)  
2. forward (중계자 : 경찰서 112상황실 통제권한), 자기 코드는 의미가 없다 > 논리제어 ...
...
forward를 가지고 있는 페이지는 아래 있는 내용이 의미 없다.
Buffer 비우고 그 Buffer에 forward 페이지의 내용을 담아요


http://localhost:8090/WebJSP/Ex13_forward_main.jsp?code=A - 호출
