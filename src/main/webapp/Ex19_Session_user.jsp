...
<!-- 
	...
	>> 접속한 사용자 마다 다른 정보를 관리 (고유하게 부여되는 session 객체) 가지고 ....
	...
	김유신 >> key 생성 >> 서버(session객체 생성) >> 고유한 key 생성 (식별값) >> 사용자의 id 저장
	--session 객체 >> id, kim
 ...
 -->
	...
	<!-- 
		request 객체 유효범위 : 요청한 페이지에서 단) include, forward를 했다면 그 페이지에서도 사용가능
